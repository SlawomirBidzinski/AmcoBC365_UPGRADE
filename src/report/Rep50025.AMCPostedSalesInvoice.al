report 50025 "AMC Posted Sales Invoice"
{
    ApplicationArea = All;
    Caption = 'Posted Sales Invoice';
    UsageCategory = ReportsAndAnalysis;
    DefaultRenderingLayout = AMCDefault;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            begin
                ...
                CurrReport.FormatRegion := Lang.GetFormatRegionOrDefault("Format Region");
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/report/layout/AMC Sales Posted Invoice.rdl';
